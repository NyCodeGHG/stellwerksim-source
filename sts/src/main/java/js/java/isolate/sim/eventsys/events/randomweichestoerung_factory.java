...
public class randomweichestoerung_factory extends eventFactory {
   private JSpinner num;
   private JCheckBox stark;

   public randomweichestoerung_factory() {
      super();
   }

   @Override
   public String getName() {
      return "zufällige Weichenstörung";
   }

   @Override
   public Class<? extends event> getEventTyp() {
      return randomweichestoerung.class;
   }
   ...
   protected void initGui() {
      ...
      this.stark.setToolTipText("es werden bevorzugt stark befahrere Weichen gestört");
   ...
   public String getDescription() {
      return "Ausfall einer zufälligen Weiche für eine einstellbare Zeit.";
   }
