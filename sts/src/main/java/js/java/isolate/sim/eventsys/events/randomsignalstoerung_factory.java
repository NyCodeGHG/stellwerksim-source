...
public class randomsignalstoerung_factory extends eventFactory {
   private JSpinner num;
   private JCheckBox stark;

   public randomsignalstoerung_factory() {
      super();
   }

   @Override
   public String getName() {
      return "zufällige Signalstörung";
   }

   @Override
   public Class<? extends event> getEventTyp() {
      return randomsignalstoerung.class;
   }
   ...
   public String getDescription() {
      return "Ausfall eines zufälligen Signals für eine einstellbare Zeit.";
   }
