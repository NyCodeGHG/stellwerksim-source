...
public class weichenstrasse extends insert {
   private JCheckBox downup = null;

   public weichenstrasse(GleisAdapter m, gleisbildModel glb) {
      super(m, glb);
   }
   ...
   protected void initInterface() {
      super.initInterface();
      this.downup = this.addBoolInput("erst nach unten", "downup", false);
      this.mklayout();
   }
   ...
   public String getName() {
      return "Weichenstrasse/Weichentrapez";
   }
