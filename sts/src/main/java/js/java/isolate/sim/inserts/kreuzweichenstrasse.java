...
public class kreuzweichenstrasse extends insert {
   public kreuzweichenstrasse(GleisAdapter m, gleisbildModel glb) {
      super(m, glb);
   }
   ...
   private void mklayout() {
      ...
      l.add(new emptytoken());
      l.add(new gleistoken(gleis.ELEMENT_KREUZUNG, gleisElements.RICHTUNG.right));
      l.add(new newlinetoken());
      l.add(new streckengleistoken());
